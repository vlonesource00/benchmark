/**
 * safe-renderer.js - Resilient Three.js WebGLRenderer Initializer for Benchmark Sandbox
 * 
 * Provides progressive fallback context configurations, DOM canvas recycling,
 * and user-facing diagnostic modal if WebGL2 is blocked/exhausted.
 */
...
export function createSafeWebGLRenderer(THREE, options = {}) {
  const {
    container = null,
    ariaLabel = 'Harbor Ring Benchmark Canvas',
